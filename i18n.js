...
const TRANSLATIONS = {
  vi: {
    ...
    footer_site_uv: "Số người ghé thăm",
    footer_site_pv: "Số lượng truy cập",
    nav_copyright: "Điều khoản & Tác quyền",
    copyright_title: "Điều khoản & Tác quyền – Lê Lê học tiếng Trung",
    copyright_hero_badge: "✍️ Quy định & Tác quyền",
    copyright_hero_title: "Điều Khoản Sử Dụng<br/><span class=\"accent-gradient\">& Tác Quyền</span>",
    copyright_hero_subtitle: "Quy định về việc chia sẻ tài nguyên phi thương mại và cam kết tôn trọng bản quyền từ Lê Lê học tiếng Trung.",
    copyright_sec1_title: "1. Chia sẻ phi thương mại và miễn phí",
    copyright_sec1_text: "Tất cả tài liệu PDF, hình ảnh infographic, bài học video, và công cụ tương tác AI (Luyện âm, Tập viết, Thẻ từ) trên website này đều được cung cấp hoàn toàn miễn phí và không yêu cầu đăng ký tài khoản. Người học được khuyến khích sử dụng và chia sẻ rộng rãi cho bạn bè phục vụ mục đích học tập cá nhân.",
    copyright_sec2_title: "2. Nghiêm cấm mọi hình thức thương mại hóa",
    copyright_sec2_text: "Chúng tôi nghiêm cấm mọi cá nhân, tổ chức sao chép, phân phối lại, chỉnh sửa hoặc kinh doanh dưới bất kỳ hình thức thương mại nào (ví dụ: gộp tài liệu bán khóa học, in ấn bán lại, gắn quảng cáo thương mại hoặc sử dụng làm tài nguyên trả phí) nếu chưa có sự đồng ý chính thức bằng văn bản từ Lê Lê.",
    copyright_sec3_title: "3. Tôn trọng tác quyền và Công cụ mở",
    copyright_sec3_text: "Mọi nội dung học liệu trên trang đều do Lê Lê tự tổng hợp và biên soạn độc quyền. Chúng tôi cam kết không lấy bản quyền của bất kỳ ai hay tổ chức nào. Đối với các công cụ tương tác, website sử dụng các thư viện mã nguồn mở uy tín (như Hanzi Writer) và APIs công cộng của trình duyệt.",
    copyright_sec4_title: "4. Báo cáo vi phạm & Liên hệ",
    copyright_sec4_text: "Nếu phát hiện bất kỳ trường hợp nào sao chép tài nguyên từ trang này để trục lợi thương mại, hoặc có câu hỏi liên quan đến bản quyền sử dụng, vui lòng liên hệ với mình qua các kênh mạng xã hội ở trang chính hoặc email chính thức.",
    copyright_btn_back: "Quay lại trang chính",
  ...
  en: {
    ...
    footer_site_uv: "Visitors",
    footer_site_pv: "Access Count",
    nav_copyright: "Terms & License",
    copyright_title: "Terms & License – Le Le Learn Chinese",
    copyright_hero_badge: "✍️ Rules & Copyright",
    copyright_hero_title: "Terms of Use<br/><span class=\"accent-gradient\">& License</span>",
    copyright_hero_subtitle: "Rules regarding free non-commercial resource sharing and copyright commitments by Le Le Learn Chinese.",
    copyright_sec1_title: "1. Free Non-Commercial Sharing",
    copyright_sec1_text: "All PDF documents, infographics, video lessons, and interactive AI tools (Pronunciation, Writing, Cards) on this website are provided 100% free and require no account registration. Learners are welcome to use and share them for personal, non-commercial educational purposes.",
    copyright_sec2_title: "2. Commercial Use Strictly Prohibited",
    copyright_sec2_text: "We strictly prohibit any individual or organization from copying, redistributing, modifying, or commercializing the content under any circumstances (such as bundling materials for paid courses, printing and reselling, running commercial ads on them, or using them as premium resources) without official written consent from Le Le.",
    copyright_sec3_title: "3. Copyright Respect & Open Source Tools",
    copyright_sec3_text: "All learning materials on this site are compiled and authored exclusively by Le Le. We commit to not infringing on anyone's or any organization's copyright. For interactive tools, the website leverages trusted open-source libraries (such as Hanzi Writer) and public browser APIs.",
    copyright_sec4_title: "4. Report Violations & Contact",
    copyright_sec4_text: "If you detect any case of commercial abuse of resources from this site, or have any copyright questions, please feel free to contact me via the social channels on the homepage or our official email.",
    copyright_btn_back: "Back to Home",
  ...
  zh: {
    ...
    footer_site_pv: "访问量",
    nav_copyright: "条款与版权",
    copyright_title: "条款与版权 – 乐乐学中文",
    copyright_hero_badge: "✍️ 规则与版权",
    copyright_hero_title: "使用条款<br/><span class=\"accent-gradient\">& 版权声明</span>",
    copyright_hero_subtitle: "乐乐学中文关于免费非商业资源共享和版权承诺的规则说明。",
    copyright_sec1_title: "1. 免费非商业共享",
    copyright_sec1_text: "本网站上的所有 PDF 资料、信息图表、视频课程以及 AI 互动工具（发音训练、手写临摹、字卡复习）均 100% 免费提供，且无需注册账号。欢迎学习者出于个人非商业教育目的下载、使用并与朋友分享。",
    copyright_sec2_title: "2. 严禁任何商业化用途",
    copyright_sec2_text: "未经乐乐书面授权，严禁任何个人或组织在任何情况下复制、重新分发、修改本站内容或将其用于任何商业用途（例如：打包资源出售付费课程、印刷转售、用于商业广告、或作为收费会员资源）。",
    copyright_sec3_title: "3. 尊重版权与开源库使用",
    copyright_sec3_text: "本站所有学术内容均由乐乐独立整理和独家编写。我们郑重承诺不侵犯任何个人或组织的版权。在互动工具方面，网站利用了值得信赖的开源库（如 Hanzi Writer）和浏览器内置的公开 API。",
    copyright_sec4_title: "4. 违规举报与联系",
    copyright_sec4_text: "如果您发现有任何商业滥用本站资源的行为，或有任何关于版权使用的疑问，请通过主页上的社交渠道或我们的官方邮箱与我联系。",
    copyright_btn_back: "返回主页",
