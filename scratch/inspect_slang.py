...
# Filter Tiếng lóng
slang_vids = [v for v in media_videos if v["category"] == "Tiếng lóng"]
# Sort by order descending
slang_vids.sort(key=lambda x: x["order"], reverse=True)

print(f"=== Category: Tiếng lóng (Total: {len(slang_vids)}) ===")
for v in slang_vids:
