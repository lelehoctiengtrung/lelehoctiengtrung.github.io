...
COVER_FLAT = os.path.join(IMAGES_DIR, "DOC-RADICALS_cover_flat.png")
PAGE3_FLAT = os.path.join(IMAGES_DIR, "DOC-RADICALS_page3_flat.png")
PAGE7_FLAT = os.path.join(IMAGES_DIR, "DOC-RADICALS_page7_flat.png")
...
def main():
    ...
    print("Creating programmatically composed mockups for Radicals...")
    
    # Check if files exist
    for f in [COVER_FLAT, PAGE3_FLAT, PAGE7_FLAT]:
    ...
    # 1. COVER MOCKUP (DOC-RADICALS_mockup.png)
    ...
    out1 = os.path.join(IMAGES_DIR, "DOC-RADICALS_mockup.png")
    mockup1.save(out1, "PNG")
    print(f"Saved Cover Mockup: {out1}")
    
    # 2. PAGE 3 MOCKUP (DOC-RADICALS_page3.png)
    bg = Image.open(BACKGROUND_PATH).copy()
    ...
    out2 = os.path.join(IMAGES_DIR, "DOC-RADICALS_page3.png")
    mockup2.save(out2, "PNG")
    print(f"Saved Page 3 Mockup: {out2}")
    
    # 3. PAGE 7 MOCKUP (DOC-RADICALS_page7.png)
    bg = Image.open(BACKGROUND_PATH).copy()
    page7 = Image.open(PAGE7_FLAT)
    page7_resized = page7.resize((target_w, target_h), Image.Resampling.LANCZOS)
    mockup3 = paste_with_shadow_and_rotate(bg, page7_resized, (center_x, center_y), angle=-2)
    out3 = os.path.join(IMAGES_DIR, "DOC-RADICALS_page7.png")
    mockup3.save(out3, "PNG")
    print(f"Saved Page 7 Mockup: {out3}")
    
    print("All radicals mockups programmatically generated successfully!")
